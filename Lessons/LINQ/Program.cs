...
// }
//
// string[] fruits = ["apple", "orange", "grapes", "mango", "Mongo", "banana"];
// var query = fruits.Where(f => f.Contains('n')).Select(f => f.ToLower()).OrderByDescending(f => f);
// Console.WriteLine(string.Join(",", query));

// var query = fruits.Where(fruit => fruit.StartsWith("M", StringComparison.OrdinalIgnoreCase) || fruit.StartsWith("B", StringComparison.OrdinalIgnoreCase));
// Console.WriteLine(string.Join(",", query));

// string[] fruits2 = { "Apple", "Orange", "Grapes", "Mango", "Banana" };
// var query2 = fruits2.Where(f => f.Length > 5 && f.Contains('a', StringComparison.Ordinal) && !f.StartsWith("G", StringComparison.Ordinal));
...
// }
//
// object[] mixed = { "Apple", 42, "Orange", 3.14, "Grapes", true, "Mango", 100, "Banana" };
// var query = mixed.OfType<string>().Where(item => item.Contains('a', StringComparison.OrdinalIgnoreCase));
// Console.WriteLine(string.Join(",", query));
...
// var query = data
//   .OfType<string>()
//   .Where((item) => item.Split(" ").Length > 1)
...
// var query = data
//     .OfType<string>()
//     .Where(item => item.Split(" ").Length >= 2)
...
var nums2 = new[] { 1, 2, 3 };
var zipped = letters.Zip(nums2, (l, n) => string.Format("{0}{1}", l, n));
